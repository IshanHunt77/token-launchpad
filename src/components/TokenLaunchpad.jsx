...
export function TokenLaunchpad() {
    ...
    const [url,setTokenUrl] = useState("")
    ...
    return  <div style={{
        ...
        <input className='inputText' type='text' placeholder='Name' onChange={(e)=>setTokenName(e.target.value)}></input> <br />
        <input className='inputText' type='text' placeholder='Symbol' onChange={(e)=>setTokenSymbol(e.target.value)}></input> <br />
        <input className='inputText' type='text' placeholder='Image URL'  onChange={(e)=>setTokenUrl(e.target.value)}></input> <br />
        <input className='inputText' type='text' placeholder='Initial Supply'  onChange={(e)=>setDecimal(e.target.value)}></input> <br />
